/******/ (() => { // webpackBootstrap
/*!*********************************!*\
  !*** ./src/acba-slider/view.js ***!
  \*********************************/
document.addEventListener('DOMContentLoaded', function () {
  const sliders = document.querySelectorAll('[data-component="beforeafterslider"]');
  sliders.forEach(slider => {
    ...
    const handleVisible = slider.getAttribute('data-handlevisible') === 'true';
    const divider = slider.querySelector('.acbaslider__divider');
    const handle = slider.querySelector('.acbaslider__divider__handle');
    const beforeLabel = slider.querySelector('.acbaslider__labels__label.-before');
    const afterLabel = slider.querySelector('.acbaslider__labels__label.-after');
